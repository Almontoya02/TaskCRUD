...
{
    public DbSet<Categoria> Categorias {get;set;}//Colecciones que se convierten en tabla al conectar a la DB
    public DbSet<Tarea> Tareas {get;set;}

    public TareasContext(DbContextOptions<TareasContext> options) :base(options) { }

        /**
            FLuentAPI: Configuración de las tablas y la BD
        **/
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Categoria>(categoria=> 
        {
            ...
            categoria.HasData(categoriasInit);//Agregar datos iniciales
        });
